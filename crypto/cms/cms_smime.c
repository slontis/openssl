...
CMS_ContentInfo *CMS_EncryptedData_encrypt_with_libctx(BIO *in, const EVP_CIPHER *cipher,
                                  ...
                                  STACK_OF(X509) *certs, unsigned int flags)
{
    ...
    cms = CMS_sign_with_libctx(NULL, NULL, certs, NULL, flags, ctx->libctx, ctx->propq);
    if (cms == NULL)
        goto err;
