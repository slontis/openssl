...
CMS_EnvelopedData_create, CMS_EnvelopedData_create_with_libctx - Create CMS envelope
...
CMS_EnvelopedData_create_with_libctx() is similar to CMS_EnvelopedData_create()
but also passes the library context I<libctx> and the property query I<propq> to
use when retrieving algorithms from providers.
