...
CMS_sign_with_libctx() is similar to CMS_sign() but also passes the library context
I<libctx> and the property query I<propq> to use when retrieving
...
CMS_sign() and CMS_sign_with_libctx() return either a valid CMS_ContentInfo structure or
