...
Sets the nonce length. The only valid value is the default value of 12 bytes.
Prior to OpenSSL 3.0 this allowed lengths less than 12, which zero padded the
leading bytes of the iv.
