...
PKCS7_encrypt, PKCS7_encrypt_with_libctx
...
PKCS7_encrypt_with_libctx() is similar to PKCS7_encrypt() but also passes the
library context I<libctx> and the property query I<propq> to use when retrieving
algorithms from providers.

=head1 RETURN VALUES

PKCS7_encrypt() and PKCS7_encrypt_with_libctx() return either a PKCS7 structure
