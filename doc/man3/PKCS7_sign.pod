...
PKCS7_sign, PKCS7_sign_with_libctx - create a PKCS#7 signedData structure
...
PKCS7_sign_with_libctx() is similar to PKCS7_sign() but also passes the library
context I<libctx> and the property query I<propq> to use when retrieving
...
PKCS7_sign() and PKCS7_sign_with_libctx() return either a valid PKCS7 structure
