...
static const char FIPS_RAND_PROPERTIES[] = "provider=fips";
...
static const OSSL_ALGORITHM fips_rands[] = {
    { "CTR-DRBG", FIPS_RAND_PROPERTIES, drbg_ctr_functions },
    { "HASH-DRBG", FIPS_RAND_PROPERTIES, drbg_hash_functions },
    { "HMAC-DRBG", FIPS_RAND_PROPERTIES, drbg_hmac_functions },
    { "TEST-RAND", FIPS_RAND_PROPERTIES, test_rng_functions },
    { NULL, NULL, NULL }
};
...
static const OSSL_ALGORITHM fips_keyexch[] = {
    ...
    { "X25519", FIPS_UNAPPROVED_PROPERTIES, x25519_keyexch_functions },
    { "X448", FIPS_UNAPPROVED_PROPERTIES, x448_keyexch_functions },
#endif
    { NULL, NULL, NULL }
};
...
#ifndef OPENSSL_NO_EC
    { "ED25519", FIPS_UNAPPROVED_PROPERTIES, ed25519_signature_functions },
    { "ED448", FIPS_UNAPPROVED_PROPERTIES, ed448_signature_functions },
...
static const OSSL_ALGORITHM fips_keymgmt[] = {
    ...
    { "X25519", FIPS_UNAPPROVED_PROPERTIES, x25519_keymgmt_functions },
    { "X448", FIPS_UNAPPROVED_PROPERTIES, x448_keymgmt_functions },
    { "ED25519", FIPS_UNAPPROVED_PROPERTIES, ed25519_keymgmt_functions },
    { "ED448", FIPS_UNAPPROVED_PROPERTIES, ed448_keymgmt_functions },
#endif
    { NULL, NULL, NULL }
};
